...
function Textbox:init(x, y, width, height, text, font, numRows)
...
function Textbox:nextChunks()
    ...
    for i = self.chunkCounter, self.chunkCounter + (self.numRows-1) do
    ...
    self.chunkCounter = self.chunkCounter + self.numRows
